...
const CARDS_SPITAL: BigCard[] = [
  ...
  { id: "instructiuni", title: "Instructiuni",        description: "Instructiuni de lucru si ghiduri aplicate pe domenii.",   icon: "📘", link: "/resurse/instructiuni" },
  ...
  { id: "ssm",          title: "SSM",                 description: "Plan P&P, evaluari risc, fise individuale, registre.",   icon: "🦺", link: "/resurse/ssm" },
  { id: "psi",          title: "PSI",                 description: "Plan PSI, evacuare, verificari stingatoare/hidranti.",   icon: "🔥", link: "/resurse/psi" },
  { id: "mediu",        title: "Mediu",               description: "Registre, AFM, plan monitorizare, RetuRO, proceduri.",  icon: "🌱", link: "/resurse/mediu" },
  { id: "hr",           title: "HR",                  description: "Fise post, registre personal, politici, training.",      icon: "👥", link: "/resurse/hr" },
  { id: "medical",      title: "Medical",             description: "Protocoale, ghiduri, planuri de urgenta, registre.",    icon: "🏥", link: "/resurse/medical" },
  { id: "iso",          title: "ISO",                 description: "ISO 9001, 14001, 45001, 50001, 13485 - documentatie.",  icon: "✅", link: "/resurse/iso" },
  { id: "it",           title: "IT & securitate",     description: "Politici IT, GDPR, ISO 27001, instructiuni.",           icon: "💻", link: "/resurse/it" },
];
...
const CARDS_COMPANIE: BigCard[] = [
  ...
  { id: "hr",           title: "HR",                  description: "Fise post, registre personal, politici, training.",      icon: "👥", link: "/resurse/hr" },
  { id: "iso",          title: "ISO",                 description: "ISO 9001, 14001, 45001, 50001, 27001 - documentatie.",   icon: "✅", link: "/resurse/iso" },
...
const CARDS_INSTITUTIE: BigCard[] = [
  ...
  { id: "mediu",        title: "Mediu",               description: "Registre, AFM, plan monitorizare, proceduri ISO 14001.", icon: "🌱", link: "/resurse/mediu" },
  { id: "hr",           title: "HR",                  description: "Fise post, registre personal, politici, training.",      icon: "👥", link: "/resurse/hr" },
  { id: "iso",          title: "ISO",                 description: "ISO 9001, 14001, 45001 - documentatie si inregistrari.", icon: "✅", link: "/resurse/iso" },
  { id: "guvernanta",   title: "Guvernanta",          description: "SCIM, etica, transparenta, avertizori, anticoruptie.",  icon: "🏢", link: "/resurse/guvernanta" },
  { id: "it",           title: "IT & securitate",     description: "Politici IT, GDPR, NIS2, instructiuni echipamente.",    icon: "💻", link: "/resurse/it" },
];
...
const SEARCH_BASE: Suggestion[] = [
  ...
  { id: "sub-ins-psi",   label: "Instructiuni / PSI",       type: "subcategory", href: "/resurse/instructiuni?q=psi" },
  { id: "sub-ins-ssm",   label: "Instructiuni / SSM",       type: "subcategory", href: "/resurse/instructiuni?q=ssm" },
  ...
  { id: "f-in05",        label: "IN-05 Instructiuni PSI evacuare.pdf",  type: "file", href: "/files/IN-05.pdf",  openInNewTab: true },
  { id: "f-iso9001",     label: "ISO 9001 - Manualul calitatii.pdf",    type: "file", href: "/files/ISO9001-Manual.pdf", openInNewTab: true },
];
...
const SEARCH_SPITAL: Suggestion[] = [
  ...
  { id: "f-po14",         label: "PO-14 Procedura deseuri medicale.pdf", type: "file", href: "/files/PO-14.pdf", openInNewTab: true },
];
...
const SEARCH_INSTITUTIE: Suggestion[] = [
  ...SEARCH_BASE,
  { id: "cat-guvernanta", label: "Guvernanta (pagina)", type: "category", href: "/resurse/guvernanta" },
];
...
export default function ResursePageClient({ stats }: Props) {
  ...
  const [sort, setSort] = useState<"Relevanta" | "Alfabetic">("Relevanta");
              ...
              {suggestions.map((sug, i) => (
                <div key={sug.id} onClick={() => go(sug)} onMouseEnter={() => setActiveIdx(i)}
                  ...
                  <span style={ui.suggType}>
                    {sug.type === "file" ? "fisier" : sug.type === "subcategory" ? "subcategorie" : "categorie"}
                  </span>
                </div>
              ))}
            </div>
