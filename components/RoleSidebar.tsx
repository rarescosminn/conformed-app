...
// ================================================================
// Sidebar 100% dinamic — generat exclusiv din useOrgConfig().
// Nu există niciun string hardcodat per org_type aici.
// Pentru a modifica labels/items → editează lib/org-config.ts
// ================================================================
'use client';
