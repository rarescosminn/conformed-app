  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { data, error: signUpErr } = await supabase.auth.signUp({
        ...
        options: {
          data: { nume: form.nume, prenume: form.prenume },
        },
      });
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: 26, fontWeight: 800, margin: '0 0 12px', color: '#111827' }}>
            Verifică-ți emailul!
          </h1>
          <p style={{ color: '#6B7280', fontSize: 15, lineHeight: 1.7, margin: '0 0 12px' }}>
            Am trimis un email de confirmare la
          </p>
          <div style={{
            display: 'inline-block', background: '#EEF2FF', color: '#4F46E5',
            fontWeight: 700, fontSize: 14, padding: '6px 18px',
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        />
        <div style={{ fontSize: 15, opacity: 0.85, textAlign: 'center', maxWidth: 300, lineHeight: 1.7, marginBottom: 40 }}>
      ...
      <div style={{
        display: 'flex', flexDirection: 'column',
        justifyContent: 'center', alignItems: 'center',
        padding: '48px 48px', background: '#f8fafc',
        overflowY: 'auto',
      }}>
        <div style={{ width: '100%', maxWidth: 440 }}>
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ color: '#6B7280', fontSize: 14, margin: 0 }}>
              90 de zile acces complet, fără card.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input style={inp} type="email" placeholder="ion@companie.ro" value={form.email} onChange={set('email')} />
            </div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  value={form.confirma_parola}
                  onChange={set('confirma_parola')}
                />
          ...
          {error && (
            <div style={{
              ...
              borderRadius: 10, fontSize: 13, margin: '16px 0',
            }}>
              {error}
            </div>
          )}
