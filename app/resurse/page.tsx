...
const SEARCH_INDEX: Suggestion[] = [
  // subcategorii Proceduri / Instrucțiuni / Template
...
const ui = {
  ...
  searchInput: {
    ...
    padding: "10px 12px 10px 36px", background: "#fff", boxShadow: "0 1px 2px rgba(0,0,0,.04)"
  } as const,
  ...
  suggBox: {
    ...
    background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, marginTop: 6,
    boxShadow: "0 8px 20px rgba(13,27,55,.08)", overflow: "hidden"
  },
  suggItem: {
  ...
  card: {
    border: "1px solid rgba(0,0,0,.06)", borderRadius: 16, background: "#fff",
    boxShadow: "0 6px 16px rgba(0,0,0,.05)", padding: 20, display: "flex", flexDirection: "column", minHeight: 200
  } as const,
  ...
  btn: {
    marginTop: 16, border: "1px solid #2563eb", background: "#2563eb", color: "#fff",
    padding: "10px 14px", borderRadius: 12, cursor: "pointer", fontWeight: 500, textAlign: "center" as const
  },
};
